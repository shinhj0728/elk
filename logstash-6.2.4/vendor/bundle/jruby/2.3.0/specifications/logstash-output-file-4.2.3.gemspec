# -*- encoding: utf-8 -*-
# stub: logstash-output-file 4.2.3 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<logstash-core-plugin-api>.freeze, ["< 2.99", ">= 2.0.0"])
      ...
      s.add_dependency(%q<logstash-core-plugin-api>.freeze, ["< 2.99", ">= 2.0.0"])
