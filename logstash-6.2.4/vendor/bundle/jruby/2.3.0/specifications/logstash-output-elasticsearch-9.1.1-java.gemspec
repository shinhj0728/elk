# -*- encoding: utf-8 -*-
# stub: logstash-output-elasticsearch 9.1.1 java lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<ftw>.freeze, ["~> 0.0.42"])
      s.add_development_dependency(%q<addressable>.freeze, ["~> 2.3.0"])
      s.add_development_dependency(%q<logstash-codec-plain>.freeze, [">= 0"])
      s.add_development_dependency(%q<json>.freeze, [">= 0"])
      s.add_development_dependency(%q<gzip>.freeze, [">= 0"])
      ...
      s.add_dependency(%q<ftw>.freeze, ["~> 0.0.42"])
      s.add_dependency(%q<addressable>.freeze, ["~> 2.3.0"])
      s.add_dependency(%q<logstash-codec-plain>.freeze, [">= 0"])
      s.add_dependency(%q<json>.freeze, [">= 0"])
      s.add_dependency(%q<gzip>.freeze, [">= 0"])
