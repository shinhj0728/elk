# -*- encoding: utf-8 -*-
# stub: logstash-output-sqs 5.1.1 ruby lib

Gem::Specification.new do |s|
  s.name = "logstash-output-sqs".freeze
  s.version = "5.1.1"
  ...
  s.summary = "Pushes events to an Amazon Web Services Simple Queue Service queue".freeze
